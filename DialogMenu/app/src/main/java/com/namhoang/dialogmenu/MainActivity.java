...
public class MainActivity extends Activity {
    ...
    private void openFloatingMenuDialog() {
        ...
        new FloatingMenuDialog(MainActivity.this)
                ...
                .setChooseFromLibraryButtonText("From Camera")
                .setChooseFromPhotoRoll("From Gallery") // Assuming a method for setting text for choosing from photo roll
                .setTakePhotoButtonText("From Google Drive")
                .setTakeVideoButtonText("Close Dialog")
